...
** Low Temperature 
Replace upper limit with ifinity. \[U=\frac{3\pi^4}{5}\frac{NkT^4}{T_{D^3}}\]. The total heat capacity is therefore \[C=\gamma T + \frac{23 \pi^4Nk}{5T_{D^3}}T^{3}\] for metal. Where $\gamma=\pi^2nk^2/2\epsilon_F$ in the free electron model.
-----
